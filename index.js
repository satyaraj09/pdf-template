...
const generatePDF = async () => {
    ...
    const footerText = (pageNum, totalPages) => {
        ...
        doc.line(marginX, marginY - 5, pageWidth - 15, marginY - 5);
        doc.setFontSize(8);
        doc.text(
            `Report Generated by: vega@gmail.com @ ${timestamp} (GMT-00:00)`,
            marginX,
            marginY
        );
        doc.text(
    ...
    doc.setFont(undefined, "bold").setFontSize(16);
    doc.text("Humidity", marginX, currentLine += 77);
    ...
    chunked.forEach((data, index) => {
        ...
        doc.setTextColor(0, 0, 0);
        doc.setFontSize(10);
        doc.text("Test", pageWidth / 2, 20, { align: "center" });
