...
const temp1Chart = await generateChart(
    labels,
    tempData1,
    "Temperature 1 °C",
    "red"
...
const temp2Chart = await generateChart(
    labels,
    tempData2,
    "Temperature 2 °C",
    "blue"
...
const generatePDF = async () => {
    ...
    doc.text("Temperature 1", marginX, currentLine += 7);
    doc.addImage(temp1Chart, "PNG", 15, currentLine += 5, pageWidth - 30, 60);

    // ====== Temperature Chart 2 ====== 
    doc.setFont(undefined, "bold").setFontSize(11);
    doc.text("Temperature 2", marginX, currentLine += 70);
    doc.addImage(temp2Chart, "PNG", 15, currentLine += 5, pageWidth - 30, 60);
    ...
    doc.save("pdfs/Dual_Temp_Seperate_Graphs.pdf");
